...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppJsx = __webpack_require__(190);

	var _reducersIndexJs = __webpack_require__(197);

	var root = document.getElementById('reactRoot');

	var store = (0, _redux.createStore)(_reducersIndexJs.AppReducer);

	var render = function render() {
	  _reactDom2['default'].render(_react2['default'].createElement(
	    _reactRedux.Provider,
	    { store: store },
	    _react2['default'].createElement(_componentsAppJsx.CurlyApp, null)
	  ), root);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oligoPaneJsx = __webpack_require__(191);

	var _sequencePaneJsx = __webpack_require__(192);

	var _resultsPaneJsx = __webpack_require__(196);

	var CurlyApp = function CurlyApp(props, context) {
	  ...
	  return _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	      'div',
	      { className: 'row' },
	      _react2['default'].createElement(_oligoPaneJsx.OligoPane, { title: 'oligos', value: state.oligos }),
	      _react2['default'].createElement(_sequencePaneJsx.SequencePane, {
	        title: 'sequence',
	    ...
	    _react2['default'].createElement(
	      'div',
	      { className: 'row' },
	      _react2['default'].createElement(_resultsPaneJsx.ResultsPane, {
	        title: 'results',
	        cuts: result.cuts,
	        time: result.time,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OligoPane = (function (_React$Component) {
	  _inherits(OligoPane, _React$Component);

	  function OligoPane(props, context) {
	    _classCallCheck(this, OligoPane);

	    _get(Object.getPrototypeOf(OligoPane.prototype), 'constructor', this).call(this, props, context);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highlightedSequenceJsx = __webpack_require__(193);

	var _sequenceOperationsJs = __webpack_require__(194);

	var _sequenceBoxJsx = __webpack_require__(195);

	var SequencePane = (function (_React$Component) {
	  _inherits(SequencePane, _React$Component);

	  function SequencePane(props, context) {
	    _classCallCheck(this, SequencePane);

	    _get(Object.getPrototypeOf(SequencePane.prototype), 'constructor', this).call(this, props, context);
	    this.handleChange = this.handleChange.bind(this);
	  ...
	  _createClass(SequencePane, [{
	    ...
	    value: function render() {
	      ...
	      var unfocusedContents = _react2['default'].createElement(_highlightedSequenceJsx.HighlightedSequence, {
	        onFocus: this.focus,
	        highlightedStrings: highlightedStrings
	      });

	      var focusedContents = _react2['default'].createElement(_sequenceBoxJsx.SequenceBox, {
	      ...
	      if (this.state.focused) contents = focusedContents;else contents = unfocusedContents;

	      return _react2['default'].createElement(
	        'div',
	        { style: style, className: 'eight columns' },
	        _react2['default'].createElement(
	          'h3',
	          null,
	          this.props.title
	...
	exports.SequencePane = SequencePane;

	SequencePane.propTypes = {
	  title: _react2['default'].PropTypes.string,
	  value: _react2['default'].PropTypes.string,
	  oligo: _react2['default'].PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightedSequence = function HighlightedSequence(_ref) {
	  var highlightedStrings = _ref.highlightedStrings;
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: 'cloud-container', onFocus: onFocus, onClick: onFocus },
	    spans
	  );
	};

	exports.HighlightedSequence = HighlightedSequence;
	HighlightedSequence.propTypes = {
	  highlightedStrings: _react2['default'].PropTypes.array,
...
/***/ function(module, exports) {
	...
	var getBasePair = function getBasePair(base) {
	  switch (base) {
	    case 'A':
	      return 'T';
	    case 'T':
	...
	exports.getBasePair = getBasePair;
	var getReverseComplement = function getReverseComplement(sequence) {
	  var revComp = '';
	...
	var findAllOligoIndices = function findAllOligoIndices(sequence, oligo) {
	  ...
	  var test = RegExp(oligo, 'g');
	  var indices = [];
	  var result = test.exec(sequence);
	  while (result) {
	...
	exports.findAllOligoIndices = findAllOligoIndices;
	var doAreasOverlap = function doAreasOverlap(highlightA, highlightB) {
	...
	var getHighlghtedAreas = function getHighlghtedAreas(sequence, oligo) {
	  var indices = findAllOligoIndices(sequence, oligo);
	  var reverseIndices = findAllOligoIndices(sequence, getReverseComplement(oligo));
	  var forwardHighlightedAreas = [];
	  var reverseHighlightedAreas = [];
	...
	var cutSeqWithOligo = function cutSeqWithOligo(sequence, oligo) {
	  ...
	  var secondSplit = [];
	  splitSeq.forEach(function (subsequence) {
	    var subSplits = subsequence.split(revComp);
	    secondSplit = secondSplit.concat(subSplits);
	  });
	  var cuts = secondSplit.length - 1;
	...
	exports.cutSeqWithOligo = cutSeqWithOligo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SequenceBox = function SequenceBox(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsPane = (function (_React$Component) {
	  _inherits(ResultsPane, _React$Component);

	  function ResultsPane() {
	    _classCallCheck(this, ResultsPane);

	    _get(Object.getPrototypeOf(ResultsPane.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(ResultsPane, [{
	    ...
	    value: function render() {
	      ...
	      var fragments = [];
	      this.props.fragments.forEach(function (fragment, index) {
	        fragments.push(_react2['default'].createElement(
	          'li',
	          { key: fragment + index },
	          _react2['default'].createElement(
	            'span',
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { style: style, className: 'twelve columns' },
	        _react2['default'].createElement(
	          'h3',
	          null,
	          this.props.title
	...
	ResultsPane.propTypes = {
	  ...
	  cuts: _react2['default'].PropTypes.number,
	  fragments: _react2['default'].PropTypes.array
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateResult = function updateResult(state) {
	  var result = (0, _sequenceOperationsJs.cutSeqWithOligo)(state.sequence, state.oligos);
	  return Object.assign({}, state, { result: result });
	};

	var setOligos = function setOligos(state, newOligos) {
	  var newState = Object.assign({}, state, { oligos: newOligos });
	  return updateResult(newState);
	};

	var setSequence = function setSequence(state, newSequence) {
	  var newState = Object.assign({}, state, { sequence: newSequence });
	  return updateResult(newState);
	};
